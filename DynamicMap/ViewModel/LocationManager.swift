...
class LocationManager: NSObject, ObservableObject, MKMapViewDelegate, CLLocationManagerDelegate {
    ...
    override init() {
        ...
        // MARK: Search text field watching
    ...
    // MARK: Add dragable pin to MapView
    func addDragablePin(coordinate: CLLocationCoordinate2D) {
    ...
    func mapView(_ mapView: MKMapView, viewFor annotation: MKAnnotation) -> MKAnnotationView? {
        let marker = MKMarkerAnnotationView(annotation: annotation, reuseIdentifier: "TARGETPIN")
